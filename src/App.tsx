...
function App() {
  ...
  const apps = [
    ...
    { icon: Chrome, name: 'Chrome', content: <webview src="https://docs.babywen.io/" className="w-full h-full border-none" title="BabyWen Documentation" />, width: 800, height: 600 },
